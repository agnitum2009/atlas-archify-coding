...
export function runDoctor(opts) {
  ...
  if (sidecar === 'ok') {
    ...
    const verdictText = {
      ...
      'unchecked-only': '本轮锚全部不可比对（broken/unparseable），未取得一致性证据',
    ...
    const parts = [
      ...
      '真比对通过 ' + head.checked + ' 条 · 免检 ' + (head.exempt.gitignored + head.exempt.noGit) +
        ...
        (head.unchecked.broken + head.unchecked.unparseable) + ' 条（broken ' + head.unchecked.broken + '、unparseable ' + head.unchecked.unparseable + '）',

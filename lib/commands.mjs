...
const FLAGS = {
  ...
  state: ['node', 'axis', 'value', 'reason', 'owner', 'receipt', 'correction', 'sidecar', 'locator', 'from', 'to', 'with-backlog'],
...
const COMMANDS = [
  ...
  },
  {
    ...
    usage: [
      ...
      'atlas-engine state set --node <id> --axis truth|progress|ledger --value <v> --reason <text> --owner <o> [--receipt <回执文件>] [--correction] [--sidecar <path>]',
